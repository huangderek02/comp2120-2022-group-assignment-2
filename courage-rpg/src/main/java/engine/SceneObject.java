...
public class SceneObject {
    ...
    final private Map<Class, List<String>> buildingArguments;

    final private List<List<Class>> cellClassMatrix;
     ...
     * */
    public void addCellClassRow(List<Class>rowList) {
     ...
     * */
    public Class getCellClassObj(int row, int col) {
